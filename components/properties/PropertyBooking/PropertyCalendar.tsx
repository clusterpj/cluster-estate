      ...
      <div className="rounded-lg border bg-background p-6 shadow-sm">
        <Calendar
          ...
          classNames={{
            ...
            month: 'space-y-4 w-72',
            caption: 'flex justify-center pt-2 relative items-center',
            caption_label: 'text-base font-medium text-foreground antialiased',
            ...
            head_row: 'flex',
            head_cell: 'text-muted-foreground rounded-md w-9 font-normal text-xs antialiased',
            ...
            day_selected: 'bg-primary text-primary-foreground hover:bg-primary/90 hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground antialiased',
            day_today: 'bg-accent text-accent-foreground antialiased',
            day_outside: 'text-muted-foreground opacity-50 dark:opacity-30 antialiased',
            day_disabled: 'text-muted-foreground opacity-50 dark:opacity-30 antialiased',
            day_range_middle: 'aria-selected:bg-accent/50 aria-selected:text-accent-foreground antialiased',
